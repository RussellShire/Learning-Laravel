{{-- basic partial, underscore in filename is convention --}}
@props(['$categories'])
    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show: false }" @click.away="show = false"> {{-- set dropdown to hidden --}}
                <button
                    @click="show = ! show" {{-- toggle show dropdown --}}
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 w-full mt-2 rounded-xl z-50" style="display: none">
                    ...
                    @foreach ($categories as $category)
                        <a href="/category/{{ $category->slug }}"
                           class="block text-left px-3 text-sm leading-6 hover:bg-blue-500 focus:bg-blue-500 hover:text-white focus:text-white
                           {{-- highlight a category blue in the dropdown if it's already selected --}}
